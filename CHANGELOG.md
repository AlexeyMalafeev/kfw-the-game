...
- **Terminal colors**: the game is no longer monochrome. A hand-rolled,
  ...
  green → yellow → red as they drain. Menu option keys are cyan (all menus),
  and the style-selection menu shows style names in white with grey short
  descriptions. All alignment code (`align_text`,
