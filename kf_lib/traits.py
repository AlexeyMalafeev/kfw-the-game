...
_TRAITS_TUP = (('careless', 'careful', {'escape_bonus': 0.3, 'training_injury': -0.05, 'thief_steals': -0.2,
                                        'item_is_lost': -0.009, 'item_is_found': 0.009}),
               ('greedy', 'generous', {'feel_too_greedy': -0.25}),
               ('lazy', 'hardworking', {'home_training_exp_mult': 0.5, 'wage_mult': 0.2,
                                        'school_training_exp_mult': 0.1}),
               ('cowardly', 'brave', {'feel_too_scared': -0.3}),
               ('narrow-minded', 'broad-minded', {'num_techs_choose': 1, 'num_techs_choose_upgrade': 1,
                                                  'num_moves_choose': 1, 'num_atts_choose': 1,
               ...
               ('undisciplined', 'disciplined', {'drink_with_drunkard': -0.2, 'gamble_with_gambler': -0.2,
                                                 'gamble_continue': -0.3}),
