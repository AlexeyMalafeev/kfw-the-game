...
PMAP = (('agility_full', 'agility', 'agility', [add_sign]),
        ...
        ('dfs_penalty_step', 'vs crowd', 'defense penalty (20% by default)', [hund, add_sign, add_pcnt]),
        ...
        ('grab_chance', 'grabs', 'grab chance', [hund, add_sign, add_pcnt]),  # todo use grab_chance boost
        ('guard_dfs_bonus', 'guard', 'guard efficiency', [hund, add_sign, add_pcnt]),
        ('guard_while_attacking', 'guard while atk', 'guard while attacking', [hund, add_sign, add_pcnt]),
        ...
        ('in_fight_impro_wp_chance', 'weapons', 'in-fight improvised weapon chance', [hund, add_sign, add_pcnt]),
