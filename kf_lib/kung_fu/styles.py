...
default_styles = [
    ...
    Style(
        'Balanced Fist',
        {
            3: Tech('Balanced Fist I', dist2_bonus=b.STRIKE_MULT1),
    ...
    Style(
        ...
        {
            3: Tech('Eight Extremities Fist I', dist1_bonus=b.STRIKE_MULT1),
    ...
    Style(
        ...
        {
            3: Tech('Gecko I', dist3_bonus=b.STRIKE_MULT1),
    ...
    Style(
        ...
        {
            3: Tech('Long Fist I', dist3_bonus=b.STRIKE_MULT1),
    ...
    Style(
        'White Crane',
        {
            ...
            5: Tech('White Crane II', dist1_bonus=b.STRIKE_MULT1),
    ...
    Style(
        'Wing Chun',
        {
            ...
            5: Tech('Wing Chun II', dist1_bonus=b.STRIKE_MULT1),
